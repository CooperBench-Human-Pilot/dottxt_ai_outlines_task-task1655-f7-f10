...
@pytest.mark.parametrize(
    ...
    [
        ...
        (types.credit_card, "1234 5678 9012 3456", True),
        (types.credit_card, "123456789012345", False),
        (types.credit_card, "1234-5678-9012 3456", False),
        (types.credit_card, "1234-56-78-9012-3456", False),
        (types.credit_card, "abcd-efgh-ijkl-mnop", False),
